...
#define SENSOR11_GPIO_Port GPIOC
...
#define SENSOR6_Pin GPIO_PIN_4
#define SENSOR6_GPIO_Port GPIOA
#define SENSOR7_Pin GPIO_PIN_5
#define SENSOR7_GPIO_Port GPIOA
#define SENSOR8_Pin GPIO_PIN_6
#define SENSOR8_GPIO_Port GPIOA
#define SENSOR9_Pin GPIO_PIN_7
#define SENSOR9_GPIO_Port GPIOA
#define SENSOR10_Pin GPIO_PIN_13
#define SENSOR10_GPIO_Port GPIOE
